<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeBehind="ShadeListForMDC.aspx.cs" Inherits="ShadeCard.ShadeListForMDC" %>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <asp:DropDownList runat="server" ID="DropStatus" CssClass="form-control" OnSelectedIndexChanged="DropStatus_SelectedIndexChanged" AutoPostBack="true">
                        ...
                        <asp:ListItem Value="M"> Approve</asp:ListItem>
            ...
            <div class="rowMargin">
                ...
                <div class="table-responsive">
                    <asp:GridView ID="gvShadeCard" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover table-checkable mb-0"
                        ...
                        OnRowCommand="gvShadeCard_RowCommand">
                        <Columns>
...
<%--    <script src="Styles/bootstrap-datepicker.js"></script>--%>
</asp:Content>
