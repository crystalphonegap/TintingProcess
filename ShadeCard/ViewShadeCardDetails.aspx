<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeBehind="ViewShadeCardDetails.aspx.cs" Inherits="ShadeCard.ViewShadeCardDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
        ...
        <div class="col-md-10">
            <asp:Repeater ID="RptColorant" runat="server" OnItemDataBound="RptColorant_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr>
                        <td>
                            <asp:TextBox ID="txtColor1" runat="server" Text='<%# Eval("COLORANT1") %>' CssClass="form-control textboxclass" onkeypress="return isNumberKey(event)" Width="100px" ReadOnly="true"></asp:TextBox>
                        </td>
                        <td>
                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# Eval("COLORANT2") %>' CssClass="form-control textboxclass" onkeypress="return isNumberKey(event)" Width="100px" ReadOnly="true"></asp:TextBox>
                        </td>
                        <td>
                            <asp:TextBox ID="TextBox2" runat="server" Text='<%# Eval("COLORANT3") %>' CssClass="form-control textboxclass" onkeypress="return isNumberKey(event)" Width="100px" ReadOnly="true"></asp:TextBox>
                        </td>
                        <td>
                            <asp:TextBox ID="TextBox3" runat="server" Text='<%# Eval("COLORANT4") %>' CssClass="form-control textboxclass" onkeypress="return isNumberKey(event)" Width="100px" ReadOnly="true"></asp:TextBox>
                        </td>
                        <td>
                            <asp:TextBox ID="TextBox4" runat="server" Text='<%# Eval("COLORANT5") %>' CssClass="form-control textboxclass" onkeypress="return isNumberKey(event)" Width="100px" ReadOnly="true"></asp:TextBox>
                        </td>
                        <td>
                            <asp:TextBox ID="TextBox5" runat="server" Text='<%# Eval("COLORANT6") %>' CssClass="form-control textboxclass" onkeypress="return isNumberKey(event)" Width="100px" ReadOnly="true"></asp:TextBox>
                        </td>
                        <td>
                            <asp:TextBox ID="TextBox6" runat="server" Text='<%# Eval("COLORANT7") %>' CssClass="form-control textboxclass" onkeypress="return isNumberKey(event)" Width="100px" ReadOnly="true"></asp:TextBox>
                        </td>
                        <td>
                            <asp:TextBox ID="TextBox7" runat="server" Text='<%# Eval("COLORANT8") %>' CssClass="form-control textboxclass" onkeypress="return isNumberKey(event)" Width="100px" ReadOnly="true"></asp:TextBox>
                        </td>
                        <td>
                            <asp:TextBox ID="TextBox8" runat="server" Text='<%# Eval("COLORANT9") %>' CssClass="form-control textboxclass" onkeypress="return isNumberKey(event)" Width="100px" ReadOnly="true"></asp:TextBox>
                        </td>
                        <td>
                            <asp:TextBox ID="TextBox9" runat="server" Text='<%# Eval("COLORANT10") %>' CssClass="form-control textboxclass" onkeypress="return isNumberKey(event)" Width="100px" ReadOnly="true"></asp:TextBox>
                        </td>
                        <td>
                            <asp:TextBox ID="TextBox10" runat="server" Text='<%# Eval("COLORANT11") %>' CssClass="form-control textboxclass" onkeypress="return isNumberKey(event)" Width="100px" ReadOnly="true"></asp:TextBox>
                        </td>
                        <td>
                            <asp:TextBox ID="TextBox11" runat="server" Text='<%# Eval("COLORANT12") %>' CssClass="form-control textboxclass" onkeypress="return isNumberKey(event)" Width="100px" ReadOnly="true"></asp:TextBox>
                        </td>
                        <td>
                            <asp:TextBox ID="TextBox12" runat="server" Text='<%# Eval("COLORANT13") %>' CssClass="form-control textboxclass" onkeypress="return isNumberKey(event)" Width="100px" ReadOnly="true"></asp:TextBox>
                        </td>
        ...
        <asp:Repeater ID="RepSKU" runat="server" OnItemDataBound="RepSKU_ItemDataBound">
            ...
            <ItemTemplate>
                <tr class="tblrowcolor ">
                    ...
                    <td>
                        <asp:TextBox ID="txtRColor1" runat="server" Text='<%#Eval("COLORANT1")%>' CssClass="form-control textboxclass" Width="100px" onkeypress="return isNumberKey(event)" ReadOnly="true"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtRColor2" runat="server" Text='<%#Eval("COLORANT2")%>' CssClass="form-control textboxclass" Width="100px" onkeypress="return isNumberKey(event)" ReadOnly="true"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtRColor3" runat="server" Text='<%#Eval("COLORANT3")%>' CssClass="form-control textboxclass" Width="100px" onkeypress="return isNumberKey(event)" ReadOnly="true"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtRColor4" runat="server" Text='<%#Eval("COLORANT4")%>' CssClass="form-control textboxclass" Width="100px" onkeypress="return isNumberKey(event)" ReadOnly="true"></asp:TextBox>
                    </td>

                    <td>
                        <asp:TextBox ID="txtRColor5" runat="server" Text='<%#Eval("COLORANT5")%>' CssClass="form-control textboxclass" Width="100px" onkeypress="return isNumberKey(event)" ReadOnly="true"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtRColor6" runat="server" Text='<%#Eval("COLORANT6")%>' CssClass="form-control textboxclass" Width="100px" onkeypress="return isNumberKey(event)" ReadOnly="true"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtRColor7" runat="server" Text='<%#Eval("COLORANT7")%>' CssClass="form-control textboxclass" Width="100px" onkeypress="return isNumberKey(event)" ReadOnly="true"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtRColor8" runat="server" Text='<%#Eval("COLORANT8")%>' CssClass="form-control textboxclass" Width="100px" onkeypress="return isNumberKey(event)" ReadOnly="true"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtRColor9" runat="server" Text='<%#Eval("COLORANT9")%>' CssClass="form-control textboxclass" Width="100px" onkeypress="return isNumberKey(event)" ReadOnly="true"></asp:TextBox>
                    </td>
                    <td>
                    ...
                    <td>
                        <asp:TextBox ID="txtRColor11" runat="server" Text='<%#Eval("COLORANT11")%>' CssClass="form-control textboxclass" Width="100px" onkeypress="return isNumberKey(event)" ReadOnly="true"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtRColor12" runat="server" Text='<%#Eval("COLORANT12")%>' CssClass="form-control textboxclass" Width="100px" onkeypress="return isNumberKey(event)" ReadOnly="true"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtRColor13" runat="server" Text='<%#Eval("COLORANT13")%>' CssClass="form-control textboxclass" Width="100px" onkeypress="return isNumberKey(event)" ReadOnly="true"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtRate1" runat="server" Text='<%#Eval("SKURATE")%>' CssClass="form-control" Width="100px" ReadOnly="true"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtWRate" runat="server" Text='<%#Eval("WSSRATE")%>' CssClass="form-control" Width="100px" ReadOnly="true"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtDRate" runat="server" Text='<%#Eval("DEALERRATE")%>' CssClass="form-control" Width="100px" ReadOnly="true"></asp:TextBox>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
    ...
    <div class="row rowMargin">
        <div class="col-md-12" runat="server" id="DivReviewerRemarks">
            <label>Reviewer Remarks</label>
            <asp:TextBox ID="txtReviewerRemarks" runat="server" CssClass="form-control" TextMode="MultiLine" ReadOnly="false"></asp:TextBox>
        </div>
        <div class="col-md-12" runat="server" id="DivApproverRemarks">
        ...
        <div class="col-md-12" runat="server" id="DivButtons" style="margin-top: 20px;">
