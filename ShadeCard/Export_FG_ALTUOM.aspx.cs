...
namespace ShadeCard
{
    public partial class Export_FG_ALTUOM : System.Web.UI.Page
    {
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@P_ACTION", "FGALTUOM");
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                using (XLWorkbook wb = new XLWorkbook())
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=" + DateTime.Now.Date.ToString("dd/MM/yyyy") + "Export_FG_ALTUOM.xlsx");
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('No Records Found.....!');window.location ='Export_FG_ALTUOM.aspx';", true);
            }
        }
