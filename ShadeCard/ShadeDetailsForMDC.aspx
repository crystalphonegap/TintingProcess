<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeBehind="ShadeDetailsForMDC.aspx.cs" Inherits="ShadeCard.ShadeDetailsForMDC" %>
        ...
        <div class="col-md-12 card-body" style="margin-bottom: 0px!important; padding-bottom: 1px">
                ...
                <asp:Repeater ID="RepSKU" runat="server" OnItemDataBound="RepSKU_ItemDataBound">
                    ...
                    <ItemTemplate>
                        <tr class="tblrowcolor ">
                            ...
                            <td>
                                <asp:TextBox ID="txtRColor10" runat="server" Text='<%#Eval("COLORANT10")%>' CssClass="form-control textboxclass" Width="100px" onkeypress="return isNumberKey(event)" ReadOnly="true"></asp:TextBox>
                            </td>
                            <td>
            ...
            <div class="row rowMargin">
                ...
                <div class="col-md-12">
                    ...
                    <asp:TextBox ID="txtApproverRemarks" runat="server" CssClass="form-control" TextMode="MultiLine" ReadOnly="true"></asp:TextBox>
                </div>
            ...
            <div class="row rowMargin">
                <div class="col-md-6">
                    ...
                    <div class="col-md-9">
                        ...
                        <asp:LinkButton runat="server" ID="btnlinkDonloadfile" OnClick="btnlinkDownloadfile_Click">

                            <i class="fa fa-download" style="font-size: 20px;">
                                <asp:Label runat="server" ID="lblfileName" Text=""></asp:Label></i>
                        </asp:LinkButton>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="col-md-9">
                        <asp:TextBox ID="txtTRNumber" runat="server" CssClass="form-control" ReadOnly="false"></asp:TextBox>
                    </div>

                </div>
                <div class="col-md-12">
                    <label>Remarks</label>
                    <asp:TextBox ID="txtMDCRemarks" runat="server" CssClass="form-control" TextMode="MultiLine" ReadOnly="false"></asp:TextBox>
                </div>
            </div>

            <div class="col-md-12" style="margin-top: 10px" runat="server" id="DivButton">
                <asp:Button runat="server" ID="btnSave" CssClass="btn btn-primary" Text="Save & Approve" OnClick="btnSave_Click" />
            </div>
