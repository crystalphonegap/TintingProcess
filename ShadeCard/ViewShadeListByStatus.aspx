<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeBehind="ViewShadeListByStatus.aspx.cs" Inherits="ShadeCard.ViewShadeListByStatus" %>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="input-group">
                       ...
                       <%-- <div class="input-group-addon" style="padding: 0px;">
                            <asp:LinkButton runat="server" ID="LinkView" CssClass="btn btn-brand-back" Style="float: right; background: #026099; color: white" OnClick="LinkView_Click"><i class="fa fa-backward" style="color:white"> Back</i></asp:LinkButton>
                        </div>--%>
                        <div class="input-group-addon" style="padding: 0px;">
                ...
                <div class="table-responsive">
                    <asp:GridView ID="gvShadeCard" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover table-checkable mb-0"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="SHADE_CODE_FTIN" HeaderText="SHADE CODE FTIN" />
