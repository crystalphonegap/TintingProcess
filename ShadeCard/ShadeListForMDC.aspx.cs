...
namespace ShadeCard
{
    public partial class ShadeListForMDC : System.Web.UI.Page
    {
        ...
        {
            cmd = new SqlCommand("PRC_MDC_GETAPPROVELIST", con);
        ...
        protected void gvShadeCard_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Session["MDCSHADEID"] = Id;
                Response.Redirect("ShadeDetailsForMDC.aspx");
            }
