<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeBehind="ViewShadeList.aspx.cs" Inherits="ShadeCard.ViewShadeList" %>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="input-group">
                        ...
                        <div class="input-group-addon" style="padding: 0px;">
                            <asp:LinkButton runat="server" ID="LinkView" CssClass="btn btn-brand-back" Style="float: right; background: #026099; color: white" OnClick="LinkView_Click"><i class="fa fa-plus" style="color:white"></i></asp:LinkButton>
                        </div>
                        <div class="input-group-addon" style="padding: 0px;">
                ...
                <div class="table-responsive">
                    <asp:GridView ID="gvShadeCard" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover table-checkable mb-0"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton runat="server" ID="linkEdit" CommandName="Edit" CommandArgument='<%# Eval("Id") %>' Text=""><i class=" fa fa-edit"></i> </asp:LinkButton>
