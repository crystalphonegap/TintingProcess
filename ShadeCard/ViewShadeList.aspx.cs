...
namespace ShadeCard
{
    public partial class ViewShadeList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    DropStatus.Items.FindByValue(Session["APSTATUS"].ToString()).Selected = true;
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('No Records Found.....!');window.location ='ViewShadeList.aspx';", true);
            }
        }
