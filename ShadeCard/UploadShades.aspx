<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeBehind="UploadShades.aspx.cs" Inherits="ShadeCard.UploadShades" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <script>
        ...
        function ConvertRGBtoHex(red, green, blue) {
            ...
            console.log("Hello");
            console.log(hexa);
            document.getElementById("<%= HColor1.ClientID %>").value = hexa;
            console.log(document.getElementById("<%= HColor1.ClientID %>").value);
        }
    ...
    <div class="card cardMargin">
        ...
        <asp:HiddenField runat="server" ID="HColor1" />
        ...
        <div class="col-md-12 card-body" style="margin-bottom: 0px!important; padding-bottom: 1px">
                ...
                <div class="col-md-3" runat="server" visible="false">
                    <div class="input-group">
                        <div class="input-group-addon" style="padding: 0px;">
                            <label class="lableclass2">Document Number :</label>
                        </div>
            ...
            <div class="row rowMargin" runat="server" visible="false">
                ...
                <div class="col-md-6">
                    <div class="col-md-3">
                        <label class="lableclass2">Level4 *</label>
                    </div>
                    <div class="col-md-9">
                ...
                <div class="col-md-6">
                    <div class="col-md-3">
                        <label class="lableclass2">Level4 Code</label>
                    </div>
                    <div class="col-md-9">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <div class="input-group-addon">
                                <input type="color" name="color1" id="HColor2" runat="server" onchange="newBackgroundColor(this.value);" class="form-control" style="width: 78px; height: 20px; padding: 0px;" />
                            </div>
                            <asp:Label ID="lblParentCode" runat="server" Text="" CssClass="form-control" Style="background-color: #c0c0c030;"></asp:Label>
